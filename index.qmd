...
for trd_prd in blotter.index:
    ...
    if prev_iv is None or not (85 < prev_iv < 90):
        qty = 0
        print("no trade")
...
```
# Outputting Interactive Blotter & Ledger (FINAL HW HERE)
```{python}
...
#    ((blotter['exit_price_underlying'] - blotter['entry_price_underlying']) / blotter['entry_price_underlying']) *
#    np.sign(blotter['qty'])
#)
